...
input sample：  container.add'load',new LoadGenerator([31，232],2,20)
                Random offeredLoad to Node 31、232,interval:2s，duration:20s
                in the end the agent will die automatically.
**/
